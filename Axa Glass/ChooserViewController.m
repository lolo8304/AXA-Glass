...
- (IBAction)takeAPhoto:(id)sender {
	...
	UIActionSheet *actionSheet = [[UIActionSheet alloc] initWithTitle:@"Choose your medium" delegate:self cancelButtonTitle:@"Cancel" destructiveButtonTitle:nil otherButtonTitles:@"Picture", @"eMail receipt", @"Scan barcode", @"Scan paper receipt", nil];
